...
func (*StringMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_83ceb6bdc15f7e25, []int{0}
}
...
func init() { proto.RegisterFile("echo.proto", fileDescriptor_83ceb6bdc15f7e25) }

var fileDescriptor_83ceb6bdc15f7e25 = []byte{
	...
	0xc9, 0x4d, 0xcc, 0xcc, 0x93, 0x92, 0x49, 0xcf, 0xcf, 0x4f, 0xcf, 0x49, 0xd5, 0x4f, 0x2c, 0xc8,
	0xd4, 0x4f, 0xcc, 0xcb, 0xcb, 0x2f, 0x49, 0x2c, 0xc9, 0xcc, 0xcf, 0x2b, 0x86, 0xa8, 0x51, 0x52,
	...
	0x70, 0x8c, 0x62, 0xb8, 0xb8, 0x23, 0xf3, 0x4b, 0x8b, 0x82, 0x21, 0xe6, 0x0b, 0xf9, 0x72, 0xb1,
	0xb8, 0x26, 0x67, 0xe4, 0x0b, 0x09, 0xeb, 0x81, 0xac, 0xd0, 0x43, 0x31, 0x41, 0x0a, 0x9b, 0xa0,
	...
	0x6e, 0x31, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xff, 0x39, 0xe9, 0xe6, 0xc5, 0x00, 0x00, 0x00,
}
...
func (c *yourServiceClient) Echo(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/main.YourService/Echo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _YourService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.YourService/Echo",
	}
